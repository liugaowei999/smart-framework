...
public abstract class BeanUtils {
	...
	public static <T> T instantiateClass(Constructor<T> ctor, Object... args) throws BeanInstantiationException {
		...
		try {
			...
			throw new BeanInstantiationException(ctor.getDeclaringClass(), "Constructor threw exception",
	 ...
	 * public
	 * methods without issues even in environments with restricted Java security
	 * settings.
	 * 
	 * @param clazz
	 *            the class to check
	 ...
	 * name
	 * matches and has the least number of parameters will be returned. When
	 * supplying an
	 * argument type list, only the method whose name and argument types match will
	 * be returned.
	 * <p>
	 * Note then that {@code methodName} and {@code methodName()} are
	 * <strong>not</strong>
	 * resolved in the same way. The signature {@code methodName} means the method
	 * called
	 * {@code methodName} with the least number of arguments, whereas
	 * {@code methodName()}
