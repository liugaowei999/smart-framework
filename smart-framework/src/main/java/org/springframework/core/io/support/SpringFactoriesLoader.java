...
/**
 * General purpose factory loading mechanism for internal use within the
 * framework.
 *
 * <p>
 * The {@code SpringFactoriesLoader} loads and instantiates factories of a given
 * type
 * from "META-INF/spring.factories" files. The file should be in
 * {@link Properties} format,
 * where the key is the fully qualified interface or abstract class name, and
 * the value
 ...
 * </pre>
 *
 * where {@code MyService} is the name of the interface, and
...
public abstract class SpringFactoriesLoader {
	...
	/**
	 * Loads the factory implementations of the given type from the default
	 * location, using
	 * the given class loader.
	 * <p>
	 * The returned factories are ordered in accordance with the
	 * {@link OrderComparator}.
	 * 
	 * @param factoryClass
	 *            the interface or abstract class representing the factory
	 * @param classLoader
	 *            the ClassLoader to use for loading (can be {@code null} to use the
	 *            default)
	 */
