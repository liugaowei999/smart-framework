 ...
 * prohibits
 * access to {@link System#getProperties()} or {@link System#getenv()}. It is
 * for this
 * reason that the implementations of {@link #keySet()}, {@link #entrySet()},
 * and
 * {@link #values()} always return empty even though {@link #get(Object)} may in
 * fact
 * return non-null if the current security manager allows access to individual
 * keys.
 *
...
abstract class ReadOnlySystemAttributesMap implements Map<String, String> {
	...
	/**
	 * @param key
	 *            the name of the system attribute to retrieve
	 * @throws IllegalArgumentException
	 *             if given key is non-String
	 */
	@Override
