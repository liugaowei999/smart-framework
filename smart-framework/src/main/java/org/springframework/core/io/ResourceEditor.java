 ...
 * {@code Resource} properties instead of using a {@code String} location
 * property.
 *
 * <p>
...
public class ResourceEditor extends PropertyEditorSupport {
	 ...
	 *            the {@code ResourceLoader} to use
	 ...
	 *            the {@code PropertyResolver} to use
	 */
	 ...
	 * @param ignoreUnresolvablePlaceholders
	 *            whether to ignore unresolvable placeholders
	 *            if no corresponding property could be found in the given
	 *            {@code propertyResolver}
	 */
	public ResourceEditor(ResourceLoader resourceLoader, PropertyResolver propertyResolver,
