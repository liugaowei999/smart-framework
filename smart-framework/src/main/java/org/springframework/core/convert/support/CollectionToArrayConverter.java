 ...
 *
 * <p>
 * First, creates a new array of the requested targetType with a length equal to
 * the
 * size of the source Collection. Then sets each collection element into the
 * array.
 * Will perform an element conversion from the collection's parameterized type
 * to the
