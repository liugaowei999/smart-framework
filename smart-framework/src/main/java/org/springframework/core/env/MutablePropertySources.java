 ...
 * sources
 * will be searched when resolving a given property with a
...
public class MutablePropertySources implements PropertySources {
	...
	/**
	 * Create a new {@link MutablePropertySources} object and inheriting the given
	 * logger,
	 ...
	 * 
	 * @param name
	 *            the {@linkplain PropertySource#getName() name of the property
	 *            source}
	 *            to find
	 * @throws IllegalArgumentException
