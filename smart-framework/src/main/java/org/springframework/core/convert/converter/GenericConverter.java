 ...
 * complex.
 * It is flexible in that a GenericConverter may support converting between
 * multiple source/target
 * type pairs (see {@link #getConvertibleTypes()}. In addition, GenericConverter
 * implementations
 * have access to source/target {@link TypeDescriptor field context} during the
 * type conversion process.
 * This allows for resolving source and target field metadata such as
