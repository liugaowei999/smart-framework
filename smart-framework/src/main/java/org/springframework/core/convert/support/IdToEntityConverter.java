...
/**
 * Converts an entity identifier to a entity reference by calling a static
 * finder method
 * on the target entity type.
 *
 * <p>
 * For this converter to match, the finder method must be public, static, have
 * the signature
 * {@code find[EntityName]([IdType])}, and return an instance of the desired
 * entity type.
 *
 * @author Keith Donald
 * @since 3.0
