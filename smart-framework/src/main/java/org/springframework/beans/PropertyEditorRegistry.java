...
/**
 * Encapsulates methods for registering JavaBeans {@link PropertyEditor
 * PropertyEditors}.
 * This is the central interface that a {@link PropertyEditorRegistrar} operates
 * on.
 *
 * <p>
...
public interface PropertyEditorRegistry {
	 ...
	 * 
	 * @param requiredType
	 *            the type of the property. This may be {@code null}
	 *            if a property is given but should be specified in any case, in
	 *            particular in
	 *            case of a Collection - making clear whether the editor is supposed
	 *            to apply
	 *            to the entire Collection itself or to each of its entries. So as a
	 *            general rule:
	 *            <b>Do not specify {@code null} here in case of a
	 *            Collection/array!</b>
	 * @param propertyPath
	 *            the path of the property (name or nested path), or
	 *            {@code null} if registering an editor for all properties of the
	 *            given type
	 * @param propertyEditor
	 *            editor to register
	 */
	 ...
	 * 
	 * @param requiredType
	 *            the type of the property (can be {@code null} if a property
	 *            is given but should be specified in any case for consistency
	 *            checking)
	 * @param propertyPath
	 *            the path of the property (name or nested path), or
	 *            {@code null} if looking for an editor for all properties of the
	 *            given type
