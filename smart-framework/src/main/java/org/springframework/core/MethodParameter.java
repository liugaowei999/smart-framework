...
public class MethodParameter {
	 ...
	 *            (typically 1; e.g. in case of a List of Lists, 1 would indicate
	 *            the
	 *            nested List, whereas 2 would indicate the element of the nested
	 *            List)
	 */
	...
	/**
	 * Return true if the parameter has at least one annotation, false if it has
	 * none.
	 */
	...
	/**
	 * Return true if the parameter has the given annotation type, and false if it
	 * doesn't.
	 */
