...
public abstract class GenericTypeResolver {
	 ...
	 * @deprecated as of Spring 4.0, use
	 ...
	 * given
	 * target method which is assumed to return the given interface or an
	 * implementation
	 * of it.
	 * 
	 * @param method
	 ...
	 *            from
	 * @return the resolved parameter type of the method return type, or
	 *         {@code null}
	 *         if not resolvable or if the single argument is of type
	 *         {@link WildcardType}.
	 */
