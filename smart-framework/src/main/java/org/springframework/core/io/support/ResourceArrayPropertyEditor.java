...
public class ResourceArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 *            the ResourcePatternResolver to use
	 * @deprecated as of 3.1 in favor of
	 *             {@link #ResourceArrayPropertyEditor(ResourcePatternResolver, PropertyResolver)}
	 */
	@Deprecated
	 ...
	 * @deprecated as of 3.1 in favor of
	 *             {@link #ResourceArrayPropertyEditor(ResourcePatternResolver, PropertyResolver, boolean)}
	 */
	@Deprecated
	public ResourceArrayPropertyEditor(ResourcePatternResolver resourcePatternResolver,
	...
	/**
	 * Treat the given text as a location pattern and convert it to a Resource
	 * array.
	 */
	@Override
	...
	/**
	 * Treat the given value as a collection or array and convert it to a Resource
	 * array.
	 * Considers String elements as location patterns and takes Resource elements
	 * as-is.
	 */
	@Override
	public void setValue(Object value) throws IllegalArgumentException {
		if (value instanceof Collection || (value instanceof Object[] && !(value instanceof Resource[]))) {
			Collection<?> input = (value instanceof Collection ? (Collection<?>) value
