...
public interface ConverterRegistry {
	 ...
	 * The convertible sourceType/targetType pair is derived from the Converter's
	 * parameterized types.
	 * 
	 ...
	 * The convertible sourceType/rangeType pair is derived from the
	 * ConverterFactory's parameterized types.
	 * 
	 * @throws IllegalArgumentException
	 *             if the parameterized types could not be resolved.
	 */
