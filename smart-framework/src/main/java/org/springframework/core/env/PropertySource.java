 ...
 * underlying
 * {@linkplain #getSource() source object} may be of any type {@code T} that
 * encapsulates
 * properties. Examples include {@link java.util.Properties} objects,
 * {@link java.util.Map}
 * objects, {@code ServletContext} and {@code ServletConfig} objects (for access
 * to init
 ...
 * rather
 * through a {@link PropertySources} object, which aggregates property sources
 * and in
 ...
 * the
 * {@code PropertySource} alone. This is useful for manipulating
 * {@code PropertySource}
 * objects when in collection contexts. See operations in
 * {@link MutablePropertySources}
 * as well as the {@link #named(String)} and {@link #toString()} methods for
 * details.
 *
 * <p>
...
public abstract class PropertySource<T> {
	 ...
	 * <p>
	 * Often useful in testing scenarios when creating
	 * anonymous implementations that never query an actual source, but rather
	 * return
	 * hard-coded values.
	 */
	...
	/**
	 * Return a hashcode derived from the {@code name} property of this
	 * {@code PropertySource}
	 * object.
	 */
	@Override
	...
	public String toString() {
		if (logger.isDebugEnabled()) {
			return String.format("%s@%s [name='%s', properties=%s]", this.getClass().getSimpleName(),
	 ...
	 * if any methods other than {@code equals(Object)}, {@code hashCode()}, and
	 * {@code toString()}
	 * are called.
	 *
	 * @param name
	 *            the name of the comparison {@code PropertySource} to be created
	 *            and returned.
	 */
	...
	static class ComparisonPropertySource extends StubPropertySource {
		...
		private static final String USAGE_ERROR = "ComparisonPropertySource instances are for collection comparison "
				+ "use only";
