 ...
 * items
 * placed into the map will be subsequently available. The garbage collector may
 * discard
 * references at any time, so it may appear that an unknown thread is silently
 * removing
 * entries.
 *
 * <p>
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
	 ...
	 *            write to the map
	 * @param referenceType
	 *            the reference type used for entries
	 */
	...
	/**
	 * Returns a {@link Reference} to the {@link Entry} for the specified
	 * {@code key} or
