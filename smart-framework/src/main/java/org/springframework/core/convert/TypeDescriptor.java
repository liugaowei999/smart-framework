...
public class TypeDescriptor implements Serializable {
	...
	private static final Class<?>[] CACHED_COMMON_TYPES = { Boolean.class, byte.class, Byte.class, char.class,
	 ...
	 * <p>
	 * See {@link #getObjectType()} for a variation of this operation that resolves
	 * primitive types
	 ...
	 * Allows such frameworks to narrow a TypeDescriptor built from a declared
	 * property, field, or method return value type.
	 * For example, a field declared as {@code java.lang.Object} would be narrowed
	 * to {@code java.util.HashMap}
	 * if it was set to a {@code java.util.HashMap} value. The narrowed
	 * TypeDescriptor can then be used to convert
	 * the HashMap to some other type. Annotation and nested type context is
	 * preserved by the narrowed copy.
	 * 
	 * @param value
	...
	/**
	 * Obtain the annotation associated with this type descriptor of the specified
	 * type.
	 * 
	 * @param annotationType
	 *            the annotation type
	 ...
	 * <p>
	 * For example,
	 * valueOf(String.class).isAssignableTo(valueOf(CharSequence.class)) returns
	 * true because a String value can be assigned to a CharSequence variable.
	 * On the other hand,
	 * valueOf(Number.class).isAssignableTo(valueOf(Integer.class)) returns false
	 ...
	 * declared.
	 * For example, a List&lt;String&gt; field value is assignable to a
	 * Collection&lt;CharSequence&gt; field, but List&lt;Number&gt; is not
	 * assignable to List&lt;Integer&gt;.
	 * 
	 * @return true if this type is assignable to the type represented by the
	 *         provided type descriptor
	 * @see #getObjectType()
	 */
	 ...
	 * If this type is a {@link Collection} and it is parameterized, returns the
	 * Collection's element type.
	 * If the Collection is not parameterized, returns null indicating the element
	 * type is not declared.
	 * 
	 * @return the array component type or Collection element type, or {@code null}
	 *         if this type is a Collection but its element type is not
	 *         parameterized
	 * @throws IllegalStateException
	 *             if this type is not a java.util.Collection or Array type
	 */
	 ...
	 * class of the provided collection or array element.
	 * For example, if this describes a java.util.List&lt;java.lang.Number&lt; and
	 * the element argument is a java.lang.Integer, the returned TypeDescriptor will
	 * be java.lang.Integer.
	 * If this describes a java.util.List&lt;?&gt; and the element argument is a
	 * java.lang.Integer, the returned TypeDescriptor will be java.lang.Integer as
	 * well.
	 * <p>
	 ...
	 * map's key type.
	 * If the Map's key type is not parameterized, returns null indicating the key
	 * type is not declared.
	 * 
	 ...
	 * class of the provided map key.
	 * For example, if this describes a java.util.Map&lt;java.lang.Number,
	 * java.lang.String&lt; and the key argument is a java.lang.Integer, the
	 * returned TypeDescriptor will be java.lang.Integer.
	 * <p>
	 * If this describes a java.util.Map&lt;?, ?&gt; and the key argument is a
	 * java.lang.Integer, the returned TypeDescriptor will be java.lang.Integer as
	 * well.
	 * <p>
	 * Annotation and nested type context will be preserved in the narrowed
	 ...
	 * <p>
	 * If the Map's value type is not parameterized, returns null indicating the
	 * value type is not declared.
	 * 
	 ...
	 * class of the provided map value.
	 * For example, if this describes a java.util.Map&lt;java.lang.String,
	 * java.lang.Number&lt; and the value argument is a java.lang.Integer, the
	 * returned TypeDescriptor will be java.lang.Integer.
	 * If this describes a java.util.Map&lt;?, ?&gt; and the value argument is a
	 * java.lang.Integer, the returned TypeDescriptor will be java.lang.Integer as
	 * well.
	 * <p>
	 * Annotation and nested type context will be preserved in the narrowed
	 ...
	 * method.
	 * The method call to construct such a {@code TypeDescriptor} would look
	 * something
	 * like:
	 ...
	 * EmailAddress&gt; by converting to a targetType built with this method:
	 * The method call to construct such a TypeDescriptor would look something like:
	 * map(Map.class, TypeDescriptor.valueOf(Id.class),
	...
	/**
	 * Creates a type descriptor for a nested type declared within the method
	 * parameter.
	 * <p>
	 ...
	 * 
	 * @param methodParameter
	 *            the method parameter with a nestingLevel of 1
	 * @param nestingLevel
	 ...
	 * level is 2, the nested type descriptor will be String, derived from the map
	 * value.
	 * <p>
	 * Returns {@code null} if a nested type cannot be obtained because it was not
	 * declared.
	 * For example, if the field is a {@code List<?>}, the nested type descriptor
	 ...
	 * <p>
	 * If the provided object is null, returns null, else calls
	...
	private static TypeDescriptor nested(TypeDescriptor typeDescriptor, int nestingLevel) {
		...
		Assert.state(nested != ResolvableType.NONE,
