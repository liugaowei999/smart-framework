...
/**
 * Converts from any JDK-standard Number implementation to any other
 * JDK-standard Number implementation.
 *
 * <p>
 * Support Number classes including Byte, Short, Integer, Float, Double, Long,
 * BigInteger, BigDecimal. This class
 * delegates to {@link NumberUtils#convertNumberToTargetClass(Number, Class)} to
