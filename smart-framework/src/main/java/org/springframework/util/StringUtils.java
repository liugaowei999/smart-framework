...
public abstract class StringUtils {
	 ...
	 *            also accepts spaces as separators, as an alternative to
	 *            underscores
	 ...
	 *            but throwing {@link IllegalArgumentException} in case of an
	 ...
	 *            (each of those characters is individually considered as
	 *            delimiter).
