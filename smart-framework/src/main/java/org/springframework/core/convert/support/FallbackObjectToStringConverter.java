 ...
 * String.
 * Supports CharSequence, StringWriter, and any class with a String constructor
 * or {@code valueOf(String)} method.
 *
 * <p>
 * Used by the default ConversionService as a fallback if there are no other
 * explicit
