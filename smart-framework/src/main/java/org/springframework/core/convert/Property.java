 ...
 * is not available in a number of environments (e.g. Android, Java ME), so this
 * is
 * desirable for portability of Spring's core conversion facility.
 *
 * <p>
 * Used to build a TypeDescriptor from a property location.
 * The built TypeDescriptor can then be used to convert from/to the property
 * type.
 *
 * @author Keith Donald
 * @author Phillip Webb
...
public final class Property {
	...
	/**
	 * The object declaring this property, either directly or in a superclass the
	 * object extends.
	 */
