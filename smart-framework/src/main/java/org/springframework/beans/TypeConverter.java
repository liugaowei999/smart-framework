...
/**
 * Interface that defines type conversion methods. Typically (but not
 * necessarily)
 ...
 * TypeConverters themselves are <em>not</em> to be considered as thread-safe
 * either.
 *
...
public interface TypeConverter {
	 ...
	 * method of the PropertyEditor class, or a Spring Converter in a
	 * ConversionService.
	 * 
	 * @param value
	 ...
	 *            (or {@code null} if not known, for example in case of a collection
	 *            element)
