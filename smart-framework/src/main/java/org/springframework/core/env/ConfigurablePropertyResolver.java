 ...
 * PropertyResolver} types. Provides facilities for accessing and customizing
 * the
...
public interface ConfigurablePropertyResolver extends PropertyResolver {
	 ...
	 *         the convenient addition and removal of individual {@code Converter}
	 *         instances:
	 * 
	 *         <pre class="code">
	 ...
	 * conversions on properties.
	 * <p>
	 * <strong>Note:</strong> as an alternative to fully replacing the {@code
	 * ConversionService}, consider adding or removing individual {@code Converter}
	 * instances by drilling into {@link #getConversionService()} and calling
	 * methods
	 ...
	 * placeholder
	 * nested within the value of a given property. A {@code false} value indicates
	 * strict
	 * resolution, i.e. that an exception will be thrown. A {@code true} value
	 * indicates
	 * that unresolvable nested placeholders should be passed through in their
	 * unresolved
	 * ${...} form.
	 * <p>
