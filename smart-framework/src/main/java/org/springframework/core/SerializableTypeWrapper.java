 ...
 * {@link Serializable} variants
 * of {@link java.lang.reflect.Type}s.
 *
 * <p>
 * {@link #forField(Field) Fields} or
 * {@link #forMethodParameter(MethodParameter)
...
abstract class SerializableTypeWrapper {
	...
	private static final Class<?>[] SUPPORTED_SERIALAZABLE_TYPES = { GenericArrayType.class, ParameterizedType.class,
	 ...
	 * {@link Type}.
	 * Provides serialization support and enhances any methods that return
	 * {@code Type}
	 * or {@code Type[]}.
	 */
