...
public class StringArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 * 
	 * @param separator
	 *            the separator to use for splitting a {@link String}
	 */
	 ...
	 * @param separator
	 *            the separator to use for splitting a {@link String}
	 * @param emptyArrayAsNull
	 *            {@code true} if an empty String array
	 ...
	 *            is to be transformed into {@code null}
	 * @param trimValues
	 *            {@code true} if the values in the parsed arrays
	 ...
	 *            trimming an input String. Useful for deleting unwanted line
	 *            breaks:
